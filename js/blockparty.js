...
var web3 = new Web3();
web3.setProvider(new web3.providers.HttpProvider('http://54.213.140.101:8545'));
...
function callHouseForSale() {
    var housePrice = document.getElementById('housePrice').value;
    document.getElementById('status').innerText = "Waiting for the transaction putting the house for sale to be mined...";
    web3.personal.unlockAccount(web3.eth.accounts[0], "Molodoi1", 1000);
    contract.forSale(housePrice);
}
...
function callHouseNotForSale() {
    document.getElementById('status').innerText = "Waiting for the transaction to remove the house from the market to be mined...";
    web3.personal.unlockAccount(web3.eth.accounts[0], "Molodoi1", 1000);
    contract.notForSale();
}
